...
import ItemBuses from "../../components/itemBuses/itemBuses";
...
const Buses = () => {
    ...
    const {data, loading, error, reFetch} = useFetch(`api/buses?city=${destination}&min=${min || 0}&max=${max || 9999}`);
                        ...
                        <div className="listBuses">
                            {
                                ...
                                <>
                                    {data.map((item=>
                                        <ItemBuses item={item} key={item._id} />
                                    ))}
                                </> 
                            )}
                        </div>
